...
SECRET_KEY = 'django-insecure-i_(y%moxq5u$98fgfswno92y0h%7(61w)*j1r-qg-#09q&6=(h'
...
# Updated paths using os.path
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Corrected template path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
